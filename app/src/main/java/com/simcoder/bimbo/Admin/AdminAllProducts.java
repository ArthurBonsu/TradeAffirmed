...
//AUTHENITICATORS
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        if (getIntent() != null) {
            traderID = getIntent().getStringExtra("fromadmincategorytoallproducts");
        }
    ...
    protected void onStart()
    {
        ...
        FirebaseRecyclerOptions<AdminOrders> options =
                new FirebaseRecyclerOptions.Builder<AdminOrders>()
                        .setQuery(MyproductsQuery, AdminOrders.class)
                        .build();
                        ...
                        if (model != null) {
                            ...
                            holder.ShowOrdersBtn.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View view) {
                                    ...
                                    Intent intent = new Intent(AdminAllProducts.this, AdminUserProductsActivity.class);
                            ...
                            holder.itemView.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View view) {
                                    ...
                                    AlertDialog.Builder builder = new AlertDialog.Builder(AdminAllProducts.this);
