...
public class RangeStyle<T extends RangeStyle> {
    ...
    private DefaultLayoutViewHelper mLayoutViewUnBindListener;

    private DefaultLayoutViewHelper mLayoutViewBindListener;
    ...
    public void setLayoutViewBindListener(DefaultLayoutViewHelper bindListener) {
        mLayoutViewBindListener = bindListener;
    }

    public void setLayoutViewUnBindListener(
            DefaultLayoutViewHelper layoutViewUnBindListener) {
