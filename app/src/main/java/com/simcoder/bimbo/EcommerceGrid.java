...
public class EcommerceGrid
{
    ...
    public EcommerceGrid() {
    }
    //careful of deliverID and deliveryID
    /// DRIVERS AVAILABLE // DRIVERS WORKING
    public EcommerceGrid(String uid, String name, String phone, String address, String city, String state, String date, String time, String totalAmount,String delivery, String products, String amount, String quantity, String shippingcost, String trader, String Users, String  price,
